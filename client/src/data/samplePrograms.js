export const SAMPLE_PROGRAMS = [
  {
    ...
    minAge: 18,
    maxAge: 28,
    maxAnnualIncome: 300000, // 3 Lakhs INR
...
export const INITIAL_SUBMISSIONS = [
  {
    ...
    status: "Pending Review", // "Pending Review", "In Review", "Approved", "Disbursed", "Ineligible"
...
export const QUICK_SAMPLE_PROMPTS = [
  {
    label: "20yo Pune Student (Job Training)",
    badge: "Example Match",
    text: "I’m a 20-year-old student from Pune. My family income is low and I want job-oriented training."
  },
  {
    label: "19yo Mumbai Girl (STEM Scholarship)",
    badge: "College Aid",
    text: "I am a 19-year-old girl in Mumbai pursuing college degree. Family income is under 2 lakhs and I need financial scholarship for tuition fees."
  },
  {
    label: "34yo Homemaker (Tailoring Grant)",
    badge: "Livelihood",
    text: "I am a 34-year-old woman in Pune with low family income. I want a sewing machine grant and small business support for tailoring."
  },
  {
    label: "21yo ITI Student (Apprenticeship & Tools)",
    badge: "Trade Grant",
    text: "I am 21 years old ITI diploma electrician from Pimpri Pune looking for starter tool kit grant and job placement."
  }
];
